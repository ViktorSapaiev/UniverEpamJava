...
public abstract class CreditRequestOperation {
    ...
    public static void createCreditRequest(Client client, Bank[] banks) throws IOException {
        if (client == null){
    ...
    private static void setBankID(Bank[] banks) throws IOException {
        try {
            ...
            bankID = Integer.parseInt(reader.readLine()) - 1;
